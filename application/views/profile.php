...
<html lang="en">
	...
	<body>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url('assets/avatars/user.jpg');?>" alt="Jasons Photo" />
												...
												<div class="widget-body">
													<div class="widget-main padding-8">
														<div id="profile-feed-1" class="profile-feed">
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="<?php echo base_url('assets/avatars/avatar5.png');?>"/>																	<a class="user" href="#"> Alex Doe </a>
		...
		<script> $.getJSON( "http://localhost/codeigniterusuaris/index.php/usuario/getusers/8", function( data ) {
			var items = [];
